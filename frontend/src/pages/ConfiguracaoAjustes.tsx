...
const ajustesTabs = [
  { id: 'ordem-manutencao', label: 'Ordem de ManutenÃ§Ã£o' },
...
const initialCodigoAtividades: CodigoAtividade[] = [
  {
    ...
    id_codigo: 'COD-100',
    nome_codigo: 'InspeÃ§Ã£o de rotina',
    sequencia_codigo: 10,
    observacao_codigo: 'Verificar integridade antes da operaÃ§Ã£oo.',
    status_codigo: 'Ativo'
  },
  {
    id_company: 'COMPANY-01',
    id_codigo: 'COD-110',
    nome_codigo: 'LubrificaÃ§Ã£o pesada',
    sequencia_codigo: 20,
  ...
  },
  {
    ...
    sequencia_codigo: 30,
    observacao_codigo: 'Executar sequÃªncias de teste apÃ³s manutenÃ§Ã£o.',
    ...
    <section style={{ display: 'flex', flexDirection: 'column' as const, gap: 16 }}>
      ...
      <header>
        ...
        <p style={{ margin: '6px 0 0', color: '#64748b' }}>
          Centralize parÃ¢metros gerais e configuraÃ§Ãµes operacionais.
        </p>
      </header>
      ...
      <Modal
        title="Editar CÃ³digo Atividade"
