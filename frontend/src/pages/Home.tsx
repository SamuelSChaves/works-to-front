...
function normalizeActionRow(entry: Record<string, unknown>): AcaoRecord {
  ...
  return {
    ...
    id_usuario_solicitante: toStringValue('id_usuario_solicitante', 'requester_id'),
    id_usuario_responsavel: toStringValue('id_usuario_responsavel', 'responsible_id'),
    ...
    origem_acao: toStringValue('origem_acao', 'origin') || 'Operação',
